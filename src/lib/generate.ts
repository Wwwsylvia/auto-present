...
export function foundryCompletionAdapter(
  deployment: string,
...
export function generatePresentationWithCompletion(
  project: Project,
  deployment: string,
  complete: FoundryChatCompletion,
): Promise<PresentationRevision> {
  return generatePresentation(project, foundryCompletionAdapter(deployment, complete));
}
...
export async function generateRevisionPatchWithCompletion(
  ...
  return generateRevisionPatch(project, instruction, foundryCompletionAdapter(deployment, complete));
}
