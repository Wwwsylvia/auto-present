    ...
    revisions: [
      {
        ...
        strategy: {
          audienceGoal: "Help judges evaluate the workflow.",
          coreMessage: "Idea2Impact saves presentation preparation time.",
          problem: "Teams lose build time preparing presentations.",
          solution: "A typed workflow generates an editable story.",
          differentiators: ["Typed revisions"],
          proofPoints: [],
          narrativeArc: ["hook", "problem", "solution", "close"],
          voiceoverDirection: "Keep narration concise.",
          demoPlan: { recommendation: "omit", rationale: "This render fixture has no demo." },
        },
        ...
        slides: [
          {
            ...
            audienceTakeaway: "Teams lose valuable build time.",
            layout: "problem",
            bullets: ["Teams lose build time"],
            visual: { type: "statement", statement: "Presentation work displaces build time." },
          ...
          },
          {
            ...
            audienceTakeaway: "A typed workflow creates the story.",
            layout: "solution",
            bullets: ["Generate typed stories"],
            visual: {
              type: "flow",
              steps: [{ label: "Brief" }, { label: "Deck" }, { label: "Video" }],
            },
          ...
          },
          {
            ...
            audienceTakeaway: "Teams can focus on building.",
            layout: "closing",
            bullets: ["More time to build"],
            visual: { type: "statement", statement: "Spend more time building." },
