              ...
              {canUseDemo && demoSlide?.visual.type === "demo" ? (
                <>
                  ...
                  <p className="demo-guidance">
                    Use the clip for this slide&apos;s promised proof. Keep the voiceover focused on
                    the audience outcome, not controls; short clips loop to fill the segment.
                  </p>
                ...
                <>
                  ...
                  <p>This approved deck has no semantic demo slide, so an upload would have no defined story moment.</p>
